  ...
  return (
    <div className="py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">{t('nav.plots')}</h1>
          <p className="text-gray-600">{t('categories.plots.description')}</p>
        </div>
              ...
              <div className="grid md:grid-cols-4 gap-4">
                <div>
                  ...
                  <select className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <option>100.000 - 500.000 TL</option>
                    <option>500.000 - 1.000.000 TL</option>
                    <option>1.000.000 TL+</option>
                  </select>
                </div>
                <div>
                  ...
                  <select className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    <option>Tümü</option>
                    <option>500 m² ve altı</option>
                    <option>500-1000 m²</option>
                    <option>1000-2000 m²</option>
                    <option>2000 m² ve üzeri</option>
                  </select>
                </div>
                <div>
