  ...
  return (
    <div className="py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Story */}
        <div className="bg-gray-800 rounded-lg shadow-sm p-8 mb-16">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">Çalışmalarımızda rehber aldığımız temel ilkeler</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div key={index} className="text-center p-6 bg-gray-800 rounded-lg shadow-sm">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-900 rounded-full mb-4">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">Deneyimli ve uzman kadromuzla sizlere hizmet veriyoruz</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <div key={index} className="text-center bg-gray-800 rounded-lg shadow-sm p-6">
                <img
                  src={member.image}
                  alt={member.name}
