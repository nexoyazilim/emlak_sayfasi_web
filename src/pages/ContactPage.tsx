                  ...
                  <div>
                    ...
                    <div className="text-gray-600 dark:text-gray-300 mt-1 space-y-1">
                      <div className="text-lg">
                        ...
                        <span className="text-sm text-gray-500 ml-2">{t('contact.emailTypes.general')}</span>
                      </div>
                      <div className="text-lg">
                        <a href="mailto:destek@emlakplus.com" className="hover:text-blue-600 transition-colors font-medium">
                          destek@emlakplus.com
                        </a>
                        <span className="text-sm text-gray-500 ml-2">{t('contact.emailTypes.support')}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    {t('contact.callNow')}: +90 212 555 0123
                  </a>
                  <a
