      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Değerlerimiz</h2>
            <p className="text-gray-600 text-lg">Çalışmalarımızda rehber aldığımız temel ilkeler</p>
          </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">Deneyimli ve uzman kadromuzla sizlere hizmet veriyoruz</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
