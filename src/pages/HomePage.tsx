  ...
  return (
    <div>
      ...
      <section className="py-12 sm:py-16 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">Neden Bizi Seçmelisiniz?</h2>
            <p className="text-gray-300 text-lg max-w-3xl mx-auto">15 yıllık deneyimimiz ve profesyonel ekibimizle size en iyi hizmeti sunuyoruz</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="bg-gray-700 rounded-xl p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Güvenilirlik</h3>
              <p className="text-gray-300">Tüm işlemlerinizde şeffaflık ve güven garantisi</p>
            </div>
            ...
            <div className="bg-gray-700 rounded-xl p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Hızlı İşlem</h3>
              <p className="text-gray-300">En kısa sürede hayalinizdeki eve kavuşun</p>
            </div>
            ...
            <div className="bg-gray-700 rounded-xl p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">7/24 Destek</h3>
              <p className="text-gray-300">Her an yanınızdayız, sorularınızı yanıtlıyoruz</p>
            </div>
            ...
            <div className="bg-gray-700 rounded-xl p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-300">Deneyimli danışmanlarımızla hizmetinizdeyiz</p>
            </div>
          </div>
        </div>
      </section>
