  ...
  return (
    <div className="py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">{t('nav.forSale')}</h1>
          <p className="text-gray-600">{t('categories.forSale.description')}</p>
        </div>
              ...
              <div className="grid md:grid-cols-4 gap-4">
                <div>
                  ...
                  <select className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <option>1.000.000 - 2.000.000 TL</option>
